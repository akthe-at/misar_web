...
urlpatterns = [
    ...
    path("files/delete_file/<int:file_id>/", views.delete_file, name="delete_file"),
    path("update_files/", views.update_files, name="update_files_table"),
    path("update_shared_files/", views.update_shared_files, name="update_shared_files"),
    ...
    path(
        "events/delete_event/<int:event_id>/", views.delete_event, name="delete_event"
    ),
